...
public class ProductPojo {
    ...
    private ArrayList<ComponentPojo> componentes;
    ...
    public void setProdutoCores(ArrayList<String> produtoCores) {
    ...
    public ArrayList<ComponentPojo> getComponentes() {
        return componentes;
    }

    public void setComponentes(ArrayList<ComponentPojo> componentes) {
